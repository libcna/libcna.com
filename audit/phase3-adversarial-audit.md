...
| Quantity | Value |
|---|---|
| Published entries | **366** = 228 bugs · 70 functional gaps · 12 platform limitations · 56 verification gaps |
| Bug severity | **2 high · 50 medium · 176 low** |
| Status | 349 open · 17 narrowed |
| Evidence basis | probable 2 · recorded-by-cna 12 · reproduced 7 · strong 13 · verified-by-reading 332 |
| Entries with a test touching the area | 315 of 366 |
| Subsystems | Graphics & renderers 68 · Documentation & release tooling 44 · Testing & evidence 43 · Networking & gamer services 32 · Math & geometry 26 · Build & CI 25 · Core & runtime 22 · Audio & media 20 · Platforms 20 · Content & XNB/CNB/CNJ 16 · Models & glTF 14 · Storage 10 · Input 9 · Diagnostics & Inspector 9 · C API & bindings 8 |
| Audit operations recorded in `dispositions.json` | folded 8 · retired 3 · reclassified 8 · added 27 |
| Independent issue reviews ingested | 341 of the 350 Phase-3 entries; CONFIRMED 223, CORRECTED 93, DUPLICATE 2, NARROWED 12, NOT A BUG 3, RECLASSIFIED 8; entries added by the audit that a separate reviewer then tried to refute: 0 of 27 |
...
| Independent auxiliary-document reviews ingested | 0 of 21 auxiliary documents; none; findings 0 (none) |
| Unit-review evidence (canonical units and auxiliary documents together) | residual paragraphs/identifiers reviewed 359 (lost-useful 19); dropped dispositions reviewed 244 (false drops 4, restore-issue 1); ledger TARGET corrections re-derived 895 (disagreements 27) |
| Unit-review findings and their outcome | 223 = fixed 221 · owner-decision 1 · restored 1 |
